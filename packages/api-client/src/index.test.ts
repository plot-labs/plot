...
it("scopes autonomy reads to the selected workspace", async () => {
  ...
  expect(fetcher.mock.calls[0]?.[0]).toBe("/api/plot/autonomy/activity?cursor=cur-1&limit=10&highWaterMark=2026-09-13T10%3A00%3A00Z");
