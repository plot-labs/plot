...
| [Agentic UX Direction](agentic-ux.md) | Session-first UX, embedded task manager, source review, packs, voice, and approval flow. |
...
- Treat source adapters as inputs to the review workspace, not the product
  surface itself.
