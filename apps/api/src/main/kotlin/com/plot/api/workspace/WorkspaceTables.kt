...
internal object WorkspaceTable : Table("workspaces") {
	...
	val polarSubscriptionStatus = varchar("polar_subscription_status", 255).nullable()
	val polarSubscriptionCancelAtPeriodEnd = bool("polar_subscription_cancel_at_period_end").nullable()
	val polarSubscriptionCurrentPeriodEnd = timestampWithTimeZone("polar_subscription_current_period_end").nullable()
	val polarSubscriptionEventAt = timestampWithTimeZone("polar_subscription_event_at").nullable()
