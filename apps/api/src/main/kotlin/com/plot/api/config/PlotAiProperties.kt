...
data class PlotAiProperties(
	...
	val creditPolicyVersion: String = "2026-09-18-v1",
) {
	...
	init {
		...
		require(creditPolicyVersion == "2026-09-18-v1") { "plot.ai.credit-policy-version must match the deployed price catalog" }
