...
describe("Plot same-origin proxy", () => {
  ...
  it.each([
    ...
    ["POST", ["agent-runs"]],
    ["GET", ["agent-runs", "models"]],
    ["GET", ["agent-runs", "018fd000-0000-7000-8000-000000000003"]],
    ["GET", ["agent-runs", "versions", "018fd000-0000-7000-8000-000000000003"]],
    ["GET", ["agent-runs", "versions", "018fd000-0000-7000-8000-000000000003", "eligibility"]],
    ["POST", ["agent-runs", "versions", "018fd000-0000-7000-8000-000000000003", "retry"]],
    ["GET", ["artifacts"]],
...
it("allows only the exact autonomy activity route and rejects legacy autonomy routes", async () => {
  ...
  for (const [method, path, status] of [
    ["GET", "autonomy/activity", 200],
    ["GET", "autonomy/home", 404],
    ["POST", `autonomy/opportunities/${id}/dismiss`, 404],
    ["POST", `autonomy/opportunities/${id}/restore`, 404],
