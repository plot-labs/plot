...
const metrics = [
  { 
    ...
    suffix: "+", 
    prefix: "",
    label: "Signals needed for a useful first brief",
  },
  { 
    value: 3,
    suffix: "", 
    prefix: "",
    label: "Accepted angles per active workspace",
  },
  { 
    value: 91,
    suffix: "%", 
    prefix: "",
    label: "Target source-backed claim ratio",
  },
  { 
    value: 4,
    suffix: "w", 
    prefix: "",
    label: "Weekly brief retention window",
  },
];
