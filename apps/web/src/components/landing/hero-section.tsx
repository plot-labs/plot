    ...
    <section className="border-b border-foreground/10 pt-32 pb-16 lg:pt-40 lg:pb-24">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        <div className="mx-auto mb-14 max-w-4xl text-center lg:mb-16">
          <p className="mb-6 font-mono text-[11px] uppercase tracking-[0.12em] text-muted-foreground">GitHub release → reviewed changelog</p>
          <h1 className="font-display text-5xl leading-[1.02] tracking-tight sm:text-7xl lg:text-[88px]">Tell customers what <br />actually shipped.</h1>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">Plot turns a published GitHub release into a source-cited changelog. Inspect the evidence behind every claim, edit the draft beside your conversation, and publish only when it’s right.</p>
        ...
        <dl className="mt-8 grid border-y border-foreground/15 sm:grid-cols-3">
          {[
            ["Release boundary", "Published GitHub release"],
            ["Evidence", "Sources stay with each claim"],
