        ...
        >
          {!sidebarOpen && (
            <button
              ...
              className="absolute left-4 top-4 z-40 hidden size-8 items-center justify-center rounded-xl text-black/42 transition hover:bg-black/5 hover:text-black/70 dark:text-white/45 dark:hover:bg-white/10 dark:hover:text-white/75 lg:inline-flex"
            >
