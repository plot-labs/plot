...
describe("Settings navigation", () => {
  ...
  it("restores product navigation outside workspace settings", async () => {
    ...
    expect(within(productNavigation).getByRole("link", { name: "Contents" })).toHaveAttribute("aria-current", "page");
  ...
  it("keeps Connections in primary navigation, including in the collapsed rail", async () => {
